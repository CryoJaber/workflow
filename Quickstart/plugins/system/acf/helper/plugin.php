...
class ACF_Field extends FieldsPlugin
{
	...
	public function onContentPrepareForm(JForm $form, $data)
	{
		...
		if (JFactory::getApplication()->isClient('administrator'))
		{
			...
			echo HTML::checkForUpdates('plg_system_acf');

			// Display a warning if the extension is more than 120 days old
			echo HTML::checkForOutdatedExtension('plg_system_acf');
		}
